...
<html lang="es">
  ...
  <body style="font-family: 'Segoe UI', sans-serif; background-color:#0078d7;" oncontextmenu="return false">
    <div class="app-page-container" style="padding:0;display: flex;height: 100vh;width: 100vw;justify-content: center;align-items: center;">
    	<div style="display:flex; flex-direction: column; padding: 1rem;height: fit-content;width: fit-content; margin-bottom: 3rem;">
	    	<div style="max-width: 420px;text-align: center; font-size: 1.2rem; color: white;">
	    		<h2>Ocurrió un error tratando de ejecutar la acción anterior.</h2>
	    	</div>
	    	<div style="max-width: 420px;text-align: center;">
	    		<a href="/" style="height: 22px;display: inline-block; background-color:#222;" class="app-btn app-btn-primary">Ir a inicio</a>
	    	</div>
    	</div>
    </div>
